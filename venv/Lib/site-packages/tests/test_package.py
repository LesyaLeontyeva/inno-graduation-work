...
class TestPackage(unittest.TestCase):
    ...
    def test_pypi_url(self):
        self.assertEquals(u"http://pypi.python.org/pypi/yarg", self.package.pypi_url)

    def test_summary(self):
        self.assertEquals(u"This is the short summary.", self.package.summary)

    def test_description(self):
        self.assertEquals(u"This is the long description.", self.package.description)

    def test_homepage(self):
        self.assertEquals(u"https://kura.io/yarg/", self.package.homepage)

    def test_bugtracker(self):
        self.assertEquals(
            u"https://github.com/kura/yarg/issues", self.package.bugtracker
        )

    def test_docs(self):
        self.assertEquals(u"http://yarg.readthedocs.org/", self.package.docs)
    ...
    def test_license(self):
        self.assertEquals(u"MIT", self.package.license)

    def test_license_from_classifiers(self):
        self.assertEquals(u"MIT License", self.package.license_from_classifiers)
    ...
    def test_release_ids(self):
        self.assertEquals([u"0.0.0", u"0.0.2", u"0.0.15"], self.package.release_ids)
    ...
    def test_python_versions(self):
        self.assertEquals(
            [u"2.6", u"2.7", u"3.1", u"3.2", u"3.3"], self.package.python_versions
        )

    def test_python_implementations(self):
        self.assertEquals([u"CPython", u"PyPy"], self.package.python_implementations)
