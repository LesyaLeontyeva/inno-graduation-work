...
class TestRelease(unittest.TestCase):
    ...
    def test_release(self):
        ...
        self.assertEquals(
            release_list[0].md5_digest, self.package.release(release_id)[0].md5_digest
        )
        self.assertEquals(
            release_list[1].md5_digest, self.package.release(release_id)[1].md5_digest
        )
        self.assertEquals(
            "3e3098611177c34706de2e10476b3e50",
    ...
    def test_release_uploaded(self):
        ...
        release = self.package.release(release_id)[0]
        self.assertEquals(
            datetime.strptime("2014-08-16T12:21:20", "%Y-%m-%dT%H:%M:%S"),
            release.uploaded,
        )
    ...
    def test_latest_release(self):
        ...
        release_list = [Release(release_id, r) for r in release]
        self.assertEquals(
            release_list[0].md5_digest, self.package.latest_release[0].md5_digest
        )
        self.assertEquals(
            release_list[1].md5_digest, self.package.latest_release[1].md5_digest
        )
        self.assertEquals(
        ...
        self.assertEquals(
            "be198baa95116c1c9d17874428e3a0c7",
